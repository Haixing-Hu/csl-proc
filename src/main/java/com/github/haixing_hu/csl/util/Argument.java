...
package com.github.haixing_hu.csl.util;
...
public final class Argument {
  ...
  public static <T> T requireNonNull(final String argumentName,
      final T argument) {
    if (argument == null) {
  ...
  public static float requireNonNegative(final String argName,
      final float arg) {
    if (arg < 0) {
      throw new IllegalArgumentException(argName + " must be non-negative.");
    }
  ...
  public static double requireNonNegative(final String argName,
      final double arg) {
    if (arg < 0) {
      throw new IllegalArgumentException(argName + " must be non-negative.");
    }
  ...
  public static <T extends Comparable<T>> T requireLessEqual(
      final String argName1, final T arg1, final String argName2,
      final T arg2) {
    final int rc = arg1.compareTo(arg2);
    if (rc > 0) {
      throw new IllegalArgumentException(argName1 + "(" + arg1
