 ...
 * <pre>
 *  package com.github.haixing_hu.csl;
 *  public final class MyEnumXmlAdaptor extends EnumXmlAdapter<MyEnum> {
...
public class EnumXmlAdapter<T extends Enum<T>> extends XmlAdapter<String, T> {
  ...
  @Override
  public T unmarshal(@Nullable String str) throws Exception {
    if (str == null) {
      return null;
    } else {
  ...
  @Override
  public String marshal(@Nullable T value) throws Exception {
    if (value == null) {
      return null;
    } else {
